sap.ui.define([
	...
	return Controller.extend("bot.Frontend.controller.Main", {
	onInit: function () {
		...
		onSendMessageToBot: function (message) {
			...
			xhr.open("POST",
				"https://mfzgurozqwt0thik-ui-middleware.cfapps.eu10.hana.ondemand.com/api/askQuestion"
			);
